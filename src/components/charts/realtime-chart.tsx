...
// ============================================================
//  RealtimeChart — 命令式 ECharts 更新
// ============================================================
//  性能关键路径:
//   1. labels 由 useChartData 预格式化，三图共享
//   2. 降采样后仅 ~600 点，replace 模式无累积风险
//   3. 数据更新 effect 仅在快照版本变化时触发 (~30fps)
// ============================================================
...
export function RealtimeChart({ title, unit, labels, series, height = 200 }: Props) {
  ...
  // ── 数据更新 — replace 模式，防止 ECharts 内部状态累积 ────
  useEffect(() => {
